...
async function main() {
  ...
  // 5. ตั้งค่ารอบเวลาเช็คชื่อ (Attendance Rounds)
  const defaultRounds = [
    { id: 1, name: "รอบที่ 1 (20:00)", startTime: "19:00", endTime: "20:30" },
    { id: 2, name: "รอบที่ 2 (21:30)", startTime: "21:00", endTime: "22:00" },
    { id: 3, name: "รอบที่ 3 (22:30)", startTime: "22:00", endTime: "23:00" },
  ];
  ...
  await prisma.globalSetting.upsert({
    ...
    create: {
      ...
      value: JSON.stringify(defaultRounds),
      description: "การตั้งค่ารอบเช็คชื่อ (JSON Array)",
    },
  });
}
